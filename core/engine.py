...
class Engine:
    ...
    def start(self):
        ...
        self.fontbold = pygame.font.Font("fonts/vera.ttf",10)
        self.fontbold.set_bold(True)
        self.bigfont = pygame.font.Font("fonts/vera.ttf",12)
        self.bigfontbold = pygame.font.Font("fonts/vera.ttf",12)
        self.bigfontbold.set_bold(True)
        self.chaucer = pygame.font.Font("fonts/BLKCHCRY.TTF",18)
        self.chaucerbold = pygame.font.Font("fonts/BLKCHCRY.TTF",18)
        self.chaucerbold.set_bold(True)
    def stop(self):
        self.running = False
        pygame.quit()
    def pause(self):
