...
class AIController(object):
    ...
    def state_idle(self):
        pass
    def object_rank(self,o):
        return (int(self.boredom_map.get(o.name,0)),m.mdist(self.agent,o))
    def search_map(self,name=None,provides=None):
        def matches(o):
            return (name and getattr(o,"name",None)==name) or (provides and provides in getattr(o,"provides",None))
        return sorted([o for o in self.agent.map.frobers if matches(o)],key=self.object_rank)
